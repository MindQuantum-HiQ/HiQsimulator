...
template <class V>
inline void kernel_compute(V &psi, std::size_t I, std::size_t d0, std::size_t d1, const __m256d m[], const __m256d mt[])
{
    __m256d v[4];
...
template <class V, class M>
inline void kernel_core(V &psi, unsigned id1, unsigned id0, M const& m, std::size_t ctrlmask)
{
    std::size_t n = psi.size();
    std::size_t d0 = 1UL << id0;
    std::size_t d1 = 1UL << id1;
...
template <class V, class M, void K(V &, unsigned, unsigned, M const&, std::size_t)>
inline void kernelK(V &v, unsigned id1, unsigned id0, M const& m, std::size_t ctrlmask)
{
