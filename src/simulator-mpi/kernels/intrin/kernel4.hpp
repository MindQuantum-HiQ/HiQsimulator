...
template <class V>
inline void kernel_compute(V &psi, std::size_t I, std::size_t d0, std::size_t d1, std::size_t d2, std::size_t d3, const __m256d m[], const __m256d mt[])
{
    __m256d v[4];
...
inline void kernel(V &psi, unsigned id3, unsigned id2, unsigned id1, unsigned id0, M const& m, std::size_t ctrlmask)
{
                ...
                for (std::size_t i2 = 0; i2 < dsorted[1]; i2 += 2 * dsorted[2]){
                    for (std::size_t i3 = 0; i3 < dsorted[2]; i3 += 2 * dsorted[3]){
                        for (std::size_t i4 = 0; i4 < dsorted[3]; ++i4){
                            kernel_compute(psi, i0 + i1 + i2 + i3 + i4, d0, d1, d2, d3, mm, mmt);
                        }
                    }
                }
            }
...
template <class V, class M>
inline void kernel_core(V &psi, unsigned id3, unsigned id2, unsigned id1, unsigned id0, M const& m, std::size_t ctrlmask)
{
    std::size_t n = psi.size();
    std::size_t d0 = 1UL << id0;
    std::size_t d1 = 1UL << id1;
